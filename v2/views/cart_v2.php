...
$v2_page_title = $site_name . ' | Your Cart';
$v2_page_id = 'cart';
...
<script>tailwind.config = { theme: { extend: { colors: { 'brand-bg': '#FFFFFF', 'brand-text': '#1A1A1A', 'brand-gray': '#6B6B6B', 'brand-red': '#8B0000' }, fontFamily: { 'sans': ['Inter', 'ui-sans-serif', 'system-ui'], 'serif': ['Playfair Display', 'serif'] } } } };</script>
<script src="https://unpkg.com/feather-icons"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/toastify-js"></script>
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">
<!-- v2 cart overrides -->
<style>
  .v2 #add-to-cart-btn, .v2 .bg-brand-text { background: #1A1A1A !important; color: #fff !important; }
  .v2 .bg-brand-bg { background: #fff !important; }
  .v2 .rounded-md, .v2 .rounded-lg { border-radius: 0 !important; }
  .v2 .font-serif { font-family: 'Inter', sans-serif !important; }
  .v2 section.relative.h-64 { margin-top: 60px; height: 200px !important; }
  ...
  .v2 .currency-switcher a.active { background: #1A1A1A !important; color: #fff !important; box-shadow: none !important; border-radius: 0 !important; }
  @media (max-width: 768px) { .v2 section.relative.h-64 { margin-top: 56px; height: 160px !important; } }
</style>
<!-- old head removed, using v2 header -->
...
<!-- V1 HEADER hidden - v2 header used -->
