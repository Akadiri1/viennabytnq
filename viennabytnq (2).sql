...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 01, 2025 at 12:22 PM
...
CREATE TABLE IF NOT EXISTS `cart_items` (
  ...
  `custom_color_name` varchar(255) DEFAULT NULL,
  `size_name` varchar(10) DEFAULT NULL,
  `custom_size_details` text,
  `total_price` decimal(10,2) NOT NULL,
  `added_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `cart_token_idx` (`cart_token`(250)),
  KEY `user_id` (`user_id`),
  KEY `product_id` (`product_id`),
  KEY `color_id` (`color_name`),
  KEY `size_id` (`size_name`)
...
(5, 'okikiola@mckodev.com.ng', 'Emmanuel Okikiola', '2025-07-31 21:06:08');
...
INSERT INTO `discounts` (`id`, `code`, `discount_type`, `discount_value`, `is_active`, `expiry_date`) VALUES
(1, 'WELCOME10', 'percentage', 10.00, 1, NULL),
(2, 'SAVE2K', 'fixed', 2000.00, 1, NULL);
...
CREATE TABLE IF NOT EXISTS `home_product` (
  `id` int NOT NULL AUTO_INCREMENT,
  `input_image` varchar(200) DEFAULT NULL,
  `input_link` varchar(200) NOT NULL,
  `date_created` date NOT NULL,
  `time_created` time NOT NULL,
...
INSERT INTO `home_product` (`id`, `input_image`, `input_link`, `date_created`, `time_created`, `visibility`) VALUES
(1, 'images/IMG_6354b316.jpg', '/shop', '2025-07-08', '25:59:55', 'show'),
(2, 'images/IMG_6378bb68.jpg', '/shop', '2025-07-08', '25:59:55', 'show'),
(3, 'images/IMG_638882ef.jpg', '/shop', '2025-07-08', '25:59:55', 'show');
...
INSERT INTO `home_video` (`id`, `video_url`, `video_text`, `visibility`, `date_created`, `time_created`) VALUES
(1, 'images/vienna.mp4', 'SPRING/SUMMER <br> VIENNA 2025\n', 'show', '0000-00-00', '00:00:00');
...
INSERT INTO `orders` (`id`, `customer_id`, `order_number`, `subtotal`, `shipping_fee`, `discount_amount`, `grand_total`, `shipping_address`, `order_status`, `payment_reference`, `created_at`) VALUES
(44, 5, 'VN-1753999135-3DE298', 120000.00, 15000.00, 0.00, 135000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'paid', 'VN-1753999135-3DE298', '2025-07-31 21:58:55'),
(43, 5, 'VN-1753998663-A9AA12', 380000.00, 5000.00, 0.00, 385000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'paid', 'VN-1753998663-A9AA12', '2025-07-31 21:51:03'),
(42, 5, 'VN-1753998649-40A687', 380000.00, 5000.00, 0.00, 385000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:50:49'),
(41, 5, 'VN-1753998526-40BD8B', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:48:46'),
(40, 5, 'VN-1753998096-B6F7A9', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:41:36'),
(39, 5, 'VN-1753997763-367052', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:36:03'),
(38, 5, 'VN-1753997760-542604', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:36:00'),
(37, 5, 'VN-1753997656-8531DA', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:34:16'),
(36, 5, 'VN-1753997425-03A54B', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:30:25'),
(35, 5, 'VN-1753997279-CE53BB', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:27:59'),
(34, 5, 'VN-1753997245-A30EE3', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:27:25'),
(33, 5, 'VN-1753997178-57F04D', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:26:18'),
(32, 5, 'VN-1753996937-1E275B', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:22:17'),
(31, 5, 'VN-1753996871-E1C65F', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:21:11'),
(30, 5, 'VN-1753996869-AEA143', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:21:09'),
(29, 5, 'VN-1753996792-0A7FA0', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:19:52'),
(28, 5, 'VN-1753995968-A9694F', 380000.00, 0.00, 0.00, 380000.00, '{\"fullName\":\"Emmanuel Okikiola\",\"address\":\"No 1 Awonusi Street Lagos State\",\"city\":\"Lagos State\",\"state\":\"benin\",\"zip\":\"123\",\"country\":\"Nigeria\"}', 'pending', NULL, '2025-07-31 21:06:08');
...
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `name`, `image_one`, `quantity`, `price_per_unit`, `color_name`, `custom_color_name`, `size_name`, `custom_size_details`) VALUES
(34, 44, 8, '', '', 1, 120000.00, 'Black', NULL, 'XS', NULL);
...
INSERT INTO `panel_products` (`id`, `name`, `visibility`, `product_text`, `price`, `stock_quantity`, `image_one`, `image_two`, `date_created`, `time_created`) VALUES
(1, 'Celeste Ruched Maxi Dress', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 100000.00, 1, 'images/LV7A8869c71d.jpg', 'images/LV7A8663579e.jpg', '0000-00-00', '00:00:00'),
(2, 'Azure Button Halter Dress', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 200000.00, 1, 'images/IMG_6413ac6d.jpg', 'images/IMG_6414db0a.jpg', '0000-00-00', '00:00:00'),
(3, 'Onyx Cowl Neck Mini Dress', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 300000.00, 1, 'images/IMG_1697d27b.jpg', 'images/IMG_1698d27b.jpg', '0000-00-00', '00:00:00'),
(4, 'Silver Sequin Draped Skirt', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 250000.00, 1, 'images/IMG_17004aa0.jpg', 'images/IMG_17012e6a.jpg', '0000-00-00', '00:00:00'),
(5, 'Ivory Tailored Blazer', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 360000.00, 1, 'images/IMG_1701_434249c9-5a86-4e77-9afd-933b3355b8cbdacd.jpg', 'images/IMG_171609f6.jpg', '0000-00-00', '00:00:00'),
(6, 'Noir Corset Top', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 400000.00, 1, 'images/IMG_17184aa0.jpg', 'images/IMG_17192e6a.jpg', '0000-00-00', '00:00:00'),
(7, 'Opulent Sequin Gown', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 380000.00, 1, 'images/IMG_638082ef.jpg', 'images/IMG_63876502.jpg', '0000-00-00', '00:00:00'),
(8, 'Classic Black Bodysuit', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 120000.00, 1, 'images/LV7A877255a4.jpg', 'images/LV7A878555a4.jpg', '0000-00-00', '00:00:00'),
(9, 'Noir Corset Top', 'show', 'An embodiment of grace, the Celeste dress features delicate ruching that flatters the silhouette. Crafted from a soft, breathable fabric in a serene sky blue, it\'s perfect for daytime events and evening soirées alike.\n\n', 930000.00, 1, 'images/IMG_17184aa0.jpg', 'images/IMG_17192e6a.jpg', '0000-00-00', '00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `product_breadcrumb`
--

DROP TABLE IF EXISTS `product_breadcrumb`;
CREATE TABLE IF NOT EXISTS `product_breadcrumb` (
  `id` int NOT NULL AUTO_INCREMENT,
  `input_image` varchar(100) NOT NULL,
...
--
-- Dumping data for table `product_breadcrumb`
--

INSERT INTO `product_breadcrumb` (`id`, `input_image`, `visibility`, `input_title`, `date_created`, `time_created`) VALUES
(1, 'images/IMG_638082ef.jpg', 'show', 'All Products', '2025-07-02', '17:12:27');
...
(1, 9, '/images/LV7A8876c71d.jpg', 'LV7A8876c71d.jpg', 0),
(2, 9, '/images/LV7A8651579e.jpg', 'LV7A8651579e.jpg', 1),
(3, 1, '/images/LV7A8876c71d.jpg', 'LV7A8876c71d.jpg', 1),
(4, 1, '/images/LV7A8651579e.jpg', 'LV7A8651579e.jpg', 3);
...
(1, '345yjhgfse3456yhbgvfc', 'VIENNABYTNQ', 'info@tuttomondocare.com', 'info@tuttomondocare.com', 'info@tuttomondocare.com', 'eight.qservers.net', 'ssl', '465', 'Abiola@2021', '02030894674', '+44(730) 756-2773', '55 John walsh tower,Montague Road, London,E11, 3ES', 'http://linkedin.com/in/', 'http://facebook.com/', 'http://instagram.com/', 'https://behance.net/', 'https://dibbble.com', 'http://twitter.com/', 'images/viennabg.png', '<p>Tutto Mondo &nbsp;is a leading care provider with over 10 years of experience. We provide tailored support to all clients and offering support to individual with long term conditions to manage their own health within the community. Our carers and nurses Deliver outstanding performance to all clients for a great result.</p>', 'United Kingdom', 'show', '2021-06-20', '11:33:49');
...
INSERT INTO `shipping_fees` (`id`, `location_name`, `fee`, `is_active`) VALUES
(1, 'Lagos', 5000.00, 1),
(2, 'Nationwide (Outside Lagos)', 15000.00, 1);
...
CREATE TABLE IF NOT EXISTS `social_links` (
  ...
  `input_icon` varchar(100) DEFAULT NULL,
  `visibility` varchar(10) NOT NULL,
  `input_link` varchar(200) DEFAULT NULL,
  `date_created` date NOT NULL,
  `time_created` time NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `social_links` (`id`, `input_name`, `input_icon`, `visibility`, `input_link`, `date_created`, `time_created`) VALUES
(1, 'Instagram', 'fa-brands fa-instagram', 'show', 'https://www.instagram.com/vienna_rtw/', '2025-07-01', '26:43:21');
